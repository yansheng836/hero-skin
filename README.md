...
- <https://github.com/yansheng836/hero-skin-lol-image>

## 王者荣耀

爬取方式：

1. 通过在线JSON数据获取英雄和皮肤信息；
4. 下载英雄皮肤图片。
...
爬取王者荣耀的英雄皮肤图片，对应python版本仓库：<https://github.com/yansheng836/hero-skin-images> 。

游戏壁纸：<https://pvp.qq.com/web201605/wallpaper.shtml>

### 统计

到目前为止，王者荣耀一共有134个英雄，894个皮肤（含伴生皮肤）。
